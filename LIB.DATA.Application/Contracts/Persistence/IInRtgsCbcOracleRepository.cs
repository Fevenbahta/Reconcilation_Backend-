...
{
    public interface IInRtgsCbcOracleRepository : IGenericRepositoryOracle<InRtgsCbcs>
    {
      
        Task<List<InRtgsCbcsOracle>> GetInRtgsCbcsByDateAsync(DateTime transactionDate);
